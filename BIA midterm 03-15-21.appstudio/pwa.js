...
const cacheName = 'BIA_midterm_03_15_21-2021-03-15 15:36:25.112364'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'BIA_midterm_03_15_21'.length) === 'BIA_midterm_03_15_21') {
